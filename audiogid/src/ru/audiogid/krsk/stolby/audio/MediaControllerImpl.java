...
public class MediaControllerImpl extends FrameLayout implements MediaController {
    ...
    public MediaControllerImpl(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        mRoot = null;
        mContext = context;
    }
